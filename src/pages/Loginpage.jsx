    ...
    return (
        <>
            <div className="min-w-screen min-h-screen bg-white flex items-center justify-center px-5 py-5">
                <div className="bg-gray-100 text-gray-500 mt-[120px] mb-[20px] rounded-3xl shadow-xl w-full overflow-hidden max-w-[1000px]">
                    <div className="md:flex w-full">
                        <div className="hidden md:block w-1/2 bg-[#88211a] py-10 px-10">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            <div className="text-center mb-10">
                                <h1 className="font-bold text-3xl text-[#88211a]">LOGIN</h1>
                            </div>
                            <div>
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input onChange={handleChange} type="email" name='email' className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-12">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input onChange={handleChange} type="password" name='password' className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button
                                            ...
                                            className="block w-full max-w-xs mx-auto focus:bg-indigo-700 bg-[#ddc87d] hover:bg-[#88211a] text-white rounded-lg px-3 py-3 font-semibold"
                                        >
                                            {buttonPressed ? (
                            ...
                            <label htmlFor="" className="text-xs text-red-600 text-center font-semibold px-1">{error.length >= 0 ? error : ""}</label>
                        </div>
                    </div>
                </div>
            </div>
